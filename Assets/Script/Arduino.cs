 ...
 */
    public class Arduino
    {
        ...
        /// </summary>
        /// <param name="serialPortName">String specifying the name of the serial port. eg COM4</param>
        public Arduino(string serialPortName) : this(serialPortName, 115200, false, 8000) { }
        ...
        public Arduino(string serialPortName, Int32 baudRate, bool autostart) : this(serialPortName, baudRate, autostart, 8000) { }
        ...
        /// <param name="serialPortName">String specifying the name of the serial port. eg COM4</param>
        /// <param name="baudRate">Baud rate.</param>
        public Arduino(string serialPortName, Int32 baudRate) : this(serialPortName, baudRate, false, 8000) { }
